...
void testing::t_test_diff_mean_same_var()
{
...
void testing::t_test_diff_mean_diff_var()
{
...
void testing::f_test_diff_mean_diff_var()
{
...
void testing::ksone_test()
{
	...
	// this function creates data sets with Gaussian distributions and stepwise increasing variance
...
void testing::kstwo_test()
{
	// routine for examining the Kolmorgoriv-Smirnov test
	// ksone use K-S criterion to compare single data set to an expected distribution
	// kstwo use K-S criterion to compare two data sets
	// kstwo compares the cumulative distribution functions of two unbinned data sets data1 and data2
	// In this function both data sets are Gaussian distributions but data2 is given a stepwise increase in variance
...
void testing::pearson_test()
{
	// routine for testing the calculation of Pearson correlation coefficient
	// this function examines two variables to find linear correlations
	// It returns linear correlation coefficient r, a probability of correlation prob and Fisher's z
	// This sample function sets up data dose and spore which show hypothetical spore count from plants 
...
void testing::spearman_test()
{
	...
	// This function looks at the solar radiation data in TABLE2.DAT and looks for correlations between columns of the table
...
{
	// This function looks at the solar radiation data in TABLE2.DAT and computes the rank order for the data therein
...
void testing::kendall_test_1()
{
	// This function looks for pair correlations in five random number generators
	...
	std::cout << std::setw(9) << "\nfunction" << std::setw(18) << "Kendall tau"; 
...
void testing::kendall_test_2()
{
	// function perform Kendall tau test on a contingency table of data of random bit sequences
	// Contingency table is prepared inside the function
	// function checks the sequences by breakig them into groups of three bits each. Each group is treated as a 3-bit binary number
	...
	// function is testing whether or not the 3-bit numbers tend to be followed by others of their own kind
	// Roughly this function tests whether groups of ones or zeroes come in more groups than they should
	// R. Sheehan 12 - 4 -2018
